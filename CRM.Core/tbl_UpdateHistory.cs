...
namespace CRM.Core
{
    public class tbl_UpdateHistory
    {
        ...
        [ForeignKey("tbl_Quotation")]
        public Nullable<int> QuotationId { get; set; }
        [ForeignKey("tbl_ContactHistory")]
        public Nullable<int> HistoryId { get; set; }
        [ForeignKey("tbl_DocumentFile")]
        public Nullable<int> DocumentFileId { get; set; }
        [ForeignKey("tbl_Ticket")]
        public Nullable<int> TicketId { get; set; }

        public tbl_ContactHistory tbl_ContactHistory { get; set; }
        public tbl_Ticket tbl_Ticket { get; set; }
        public tbl_Quotation tbl_Quotation { get; set; }
        public tbl_Contract tbl_Contract { get; set; }
        public tbl_DocumentFile tbl_DocumentFile { get; set; }
