                ...
                using (var stream = new MemoryStream())
                {
                    if (form["listItemId"] != null && form["listItemId"] != "")
                    {
                        ...
                        if (listIds.Count() > 0)
                        {
                            ...
                            filename = "[VIETLIKE] Thống kê nhật ký hệ thống";
                    ...
                    else
                    {
                        ...
                        filename = "[VIETLIKE] Thống kê nhật ký hệ thống từ ngày " + Convert.ToDateTime(form["tungay"]).ToString("dd-MM-yyyy") + " đến " + Convert.ToDateTime(form["denngay"]).ToString("dd-MM-yyyy");
