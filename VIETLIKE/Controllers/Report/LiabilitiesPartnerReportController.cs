...
namespace VIETLIKE.Controllers.Report
{
    [Authorize]
                ...
                using (var stream = new MemoryStream())
                {
                    if (form["listItemId"] != null && form["listItemId"] != "")
                    {
                        ...
                        if (listIds.Count() > 0)
                        {
                            ...
                            filename = "[VIETLIKE] Thống kê doanh thu - công nợ đối tác từ";
                    ...
                    else
                    {
                        ...
                        filename = "[VIETLIKE] Thống kê doanh thu - công nợ đối tác từ " + Convert.ToDateTime(form["tungay"]).ToString("dd-MM-yyyy") + " đến " + Convert.ToDateTime(form["denngay"]).ToString("dd-MM-yyyy");
