                ...
                using (var stream = new MemoryStream())
                {
                    if (form["listItemId"] != null && form["listItemId"] != "")
                    {
                        ...
                        if (listIds.Count() > 0)
                        {
                            ...
                            filename = "[VIETLIKE] Thống kê báo cáo danh sách khách hàng đã giao dịch";
                    ...
                    else
                    {
                        ...
                        filename = "[VIETLIKE] Thống kê báo cáo danh sách khách hàng đã giao dịch từ " + Convert.ToDateTime(form["tungay"]).ToString("dd-MM-yyyy") + " đến " + Convert.ToDateTime(form["denngay"]).ToString("dd-MM-yyyy");
