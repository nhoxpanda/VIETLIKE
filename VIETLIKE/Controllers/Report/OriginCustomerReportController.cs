...
namespace VIETLIKE.Controllers
{
    [Authorize]
                ...
                using (var stream = new MemoryStream())
                {
                    if (form["listItemId"] != null && form["listItemId"] != "")
                    {
                        ...
                        if (listIds.Count() > 0)
                        {
                            ...
                            filename = "[VIETLIKE] Thống kê khách hàng";
                    ...
                    else
                    {
                        ...
                        filename = "[VIETLIKE] Thống kê khách hàng " + (nguonden != "" ? "đến từ nguồn: " + nguonden : "") + " từ ngày " + Convert.ToDateTime(form["tungay"]).ToString("dd-MM-yyyy") + " đến " + Convert.ToDateTime(form["denngay"]).ToString("dd-MM-yyyy");
        ...
        public virtual void ExportCustomerToXlsx(Stream stream, IList<CustomerListViewModel> tours, string headername)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                foreach (var t in tours)
                {
                    ...
                    worksheet.Cells[row, col].Value = t.Address + "," + (t.TagsId != null ? VIETLIKE.Utilities.LoadData.LocationTags(t.TagsId) : "");
                    col++;
