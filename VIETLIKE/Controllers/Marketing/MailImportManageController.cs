...
namespace VIETLIKE.Controllers.Marketing
{
    public class MailImportManageController : BaseController
    {
        ...
        public ActionResult ExcelSample()
        {
            try
            {
                ...
                {
                    string templateFile = System.Web.HttpContext.Current.Server.MapPath("~\\Upload\\ImportExport\\Import_EmailVietlike.xlsx");
                    ExportExcelTemplateCustomer(stream, templateFile, header); 
                    bytes = stream.ToArray();
                }

                string fileName = "Mau-import-email-Vietlike.xlsx";
