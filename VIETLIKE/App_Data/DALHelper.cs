...
namespace VIETLIKE.App_Data
{
    public static class DALHelper
    {
        private static IDbConnection _db = new SqlConnection("Data Source=103.27.239.106;Initial Catalog=Web_VietLike;user id=Web_VietLike_login;password=SIKU%$^#HJGF;Integrated Security=false;MultipleActiveResultSets=True");
